...
public class PositionListActivity extends Activity {
    ...
    protected void onResume() {
        super.onResume();
        ListView list = findViewById(R.id.positionListView);
        try {
            List<String> data = typesDao.getAllPositions();
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View
                ...
                final AlertDialog.Builder builder = new AlertDialog
                        .Builder(PositionListActivity.this);
                builder.setTitle(getString(R.string.name_edit));

                final EditText input = new EditText(PositionListActivity.this);
                ...
                builder.setPositiveButton(getString(R.string.save_button), new DialogInterface
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (typesDao.updatePosition(selected, edited)) {
                            Toast.makeText(PositionListActivity.this,
                                    getString(R.string.complete_modification),
                                           Toast.LENGTH_SHORT).show();
                            onResume();

                        } else {
                            Toast.makeText(PositionListActivity.this, edited +
                ...
                builder.setNegativeButton(getString(R.string.delete_button), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        confirm.setPositiveButton(getString(R.string.delete_button), new DialogInterface
                            ...
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                typesDao.deletePosition(selected);
                                Toast.makeText(PositionListActivity.this,
                                               selected + getString(R.string.deleted),
                                        Toast.LENGTH_SHORT).show();
                                onResume();
    ...
    public void onClickAddNewPosition(View view) {
        ...
        builder.setPositiveButton(getString(R.string.positive_button), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(PositionListActivity.this, name + getString(R.string.added), Toast.LENGTH_SHORT).show();
                PositionListActivity.this.onResume();
            }
        });
